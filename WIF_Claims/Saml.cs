...
namespace Saml
{
	...
	public partial class Response
	{
		...
		public List<Microsoft.IdentityModel.Claims.Claim> Claims { get; set; }
		public List<Microsoft.IdentityModel.Claims.Claim> UserClaims { get; set; }
		...
		private bool ValidateSignatureReference(SignedXml signedXml)
		{
			...
			{
				var assertionNode = _xmlDoc.SelectSingleNode("/saml2p:Response/saml2:Assertion", _xmlNameSpaceManager) as XmlElement;
		...
		private bool IsExpired()
		{
			...
			XmlNode node = _xmlDoc.SelectSingleNode("/saml2p:Response/saml2:Assertion[1]/saml2:Subject/saml2:SubjectConfirmation/saml2:SubjectConfirmationData", _xmlNameSpaceManager);
		...
		{
			XmlNode node = _xmlDoc.SelectSingleNode("/saml2p:Response/saml2:Assertion[1]/saml2:Subject/saml2:NameID", _xmlNameSpaceManager);
		...
		public virtual string GetGroupClaims()
        {
			//var claims = new List<System.IdentityModel.Claims.Claim>();
			List<string> claims = new List<string>();

			var attributeNodes = _xmlDoc.SelectNodes("/saml2p:Response/saml2:Assertion[1]/saml2:AttributeStatement/saml2:Attribute/saml2:AttributeValue", _xmlNameSpaceManager);

			if (attributeNodes != null)
			{
				var rclaims = new List<Microsoft.IdentityModel.Claims.Claim>();
				foreach (XmlNode attributeNode in attributeNodes)
                {
					claims.Add(attributeNode.InnerText);
					var rclaim = new Microsoft.IdentityModel.Claims.Claim(ClaimTypes.Role, attributeNode.InnerText);
					rclaims.Add(rclaim);
				}
				Claims = rclaims;
			}
			...
			//	return attributeNode == null ? null : attributeNode.InnerText;

			//return GetCustomAttribute("http://schemas.microsoft.com/ws/2008/06/identity/claims/role");
		...
		private void GetClaims()
        {
			...
			var attributeNodes = _xmlDoc.SelectNodes("/saml2p:Response/saml2:Assertion[1]/saml2:AttributeStatement/saml2:Attribute[@Name='role']/saml2:AttributeValue", _xmlNameSpaceManager);
		...
		{
			XmlNode node = _xmlDoc.SelectSingleNode("/saml2p:Response/saml2:Assertion[1]/saml2:AttributeStatement/saml2:Attribute[@Name='" + attr + "']/saml2:AttributeValue", _xmlNameSpaceManager);
